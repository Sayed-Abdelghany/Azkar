...
final List<CategoryModel> mosque = [
  CategoryModel('دُعَاءُ الذَّهَابِ إلَى المَسْجِدِ',
  ...
  CategoryModel('دُعَاءُ دُخُولِ المَسْجِدِ',
  ...
  CategoryModel('دُعَاءُ الخُرُوجِ مِنَ المَسْجِدِ',
